...
export default function Hero({ onOpenForm }) {
    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden text-white font-[Inter]">
            ...
            <div style={{ fontFamily: '"Fragment Mono", monospace' }} className="absolute lg:rotate-[-15deg] rotate-[-35deg] -left-70 bottom-240 z-30 flex lg:bottom-90 overflow-x-auto bg-[#43d6ff] text-black py-2 text-[14px] font-semibold shadow-[0_8px_20px_rgba(0,0,0,0.45)] whitespace-nowrap">
